use interfaces::AppTrait;
use interfaces::CarTrait;
use interfaces::DriverTrait;
use interfaces::UiTrait;

use interfaces::Kilometer;
use interfaces::OutputState;
...
impl State {
    fn set_steering(&mut self, steering: Steering) {
    ...
    fn update_mileage(&mut self) {
        self.mileage += self.speed as Kilometer;
    }
}

impl State {
    fn to_output(&self) -> OutputState {
